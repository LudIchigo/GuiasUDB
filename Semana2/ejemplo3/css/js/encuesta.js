...
per1 = Math.round((cont1/total) * Math.pow(10,2))/Math.pow(10,2)//Obtener el porcentajes de la segunda respuesta
per2 = Math.round((cont2/total) * Math.pow(10,2))/Math.pow(10,2);
//Obtener el porcentajes de la tercera respuestaper3 = Math.round((cont3/total) * Math.pow(10,2))/Math.pow(10,2);
